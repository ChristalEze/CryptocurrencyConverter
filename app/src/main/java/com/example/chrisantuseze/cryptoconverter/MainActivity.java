...
public class MainActivity extends AppCompatActivity{
    ...
    private void faitArrayList(){
        ...
        list.add(new ItemData("Canadian Dollar",R.drawable.canada));
        list.add(new ItemData("British Pound",R.drawable.uk));
        list.add(new ItemData("Euro ",R.drawable.sa));
        list.add(new ItemData("Chinese Yuan",R.drawable.china));
        list.add(new ItemData("Brazilian Real",R.drawable.bra));
        list.add(new ItemData("Russian Rubble",R.drawable.russia));
        list.add(new ItemData("Australian Dollar",R.drawable.australia));
        list.add(new ItemData("Nigerian Naira",R.drawable.ngn));
        list.add(new ItemData("U.S Dollar",R.drawable.usa));
        list.add(new ItemData("Swiss Franc",R.drawable.switzerland));
        list.add(new ItemData("Togolese Franc",R.drawable.togo));
        list.add(new ItemData("Denmark Krone",R.drawable.denmark));
        list.add(new ItemData("Egyptian Pound",R.drawable.egypt));
        list.add(new ItemData("Ghanian Cedi",R.drawable.ghana));
        list.add(new ItemData("India Rupee",R.drawable.india));
        list.add(new ItemData("Israeli New shekel",R.drawable.israel));
        list.add(new ItemData("Kenyan Shillings",R.drawable.kenya));
        list.add(new ItemData("Liberian Dollar",R.drawable.liberia));
        list.add(new ItemData("Malaysian Ringgit",R.drawable.malaysia));
        list.add(new ItemData("Japan Yen",R.drawable.japan1));
        FiatAdapter baseAdapter=new FiatAdapter(this,
    ...
    private void cryptoArrayList(){
        ...
        ArrayList<ItemData> list=new ArrayList<>();
        list.add(new ItemData("Bitcoin",R.drawable.images1));
        list.add(new ItemData("Ethereum",R.drawable.ethereum));
